...
prompt = "Sumi-e painting, fishing boats returning at dusk, oars moving in rhythm, sunset glow (soft orange ink wash) on the horizon, camera panning across the river, ink gradients from dark to light, minimalistic boats and water, smooth motion."
